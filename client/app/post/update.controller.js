...
* @Last Modified time: 2016-06-12 15:11:01
*/
...
(function() {
    ...
    PostUpdateController.$inject = ['$scope', '$location', 'Util', '$routeParams', 'Auth', 'Channel', 'Post', 'ygDialog'];

    /* @ngInject */
    function PostUpdateController($scope, $location, Util, $routeParams, Auth, Channel, Post, ygDialog) {
        var $ctrl = this;
